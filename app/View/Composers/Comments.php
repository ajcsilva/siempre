...
class Comments extends Composer {
  ...
  public function previous() {
    ...
    return get_previous_comments_link(__('&larr; Older comments', 'radicle'));
  }
  ...
  public function next() {
    ...
    return get_next_comments_link(__('Newer comments &rarr;', 'radicle'));
  }
